/**
 * Function to validate add_category form after submit
 * @returns {boolean}
 */
function validate_add_category(){
    ...
    document.getElementById("category_text").style.border = "solid green";
    const category_text = document.getElementById("category_text").value.trim().replace(/['"]+/g, '');
    ...
    document.getElementsByClassName("form_requirements_addcat")[0].innerHTML += new_html;

    if (category_text_problem){
        document.getElementById("category_text").style.border = "solid red";
    }
